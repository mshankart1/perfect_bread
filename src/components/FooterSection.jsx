    ...
    <div className="bg-primary w-full overflow-hidden text-white">
      <div className="container z-2 py-10 grid grid-cols-5 gap-10 max-md:gap-3 px-5 max-md:px-4 relative">
        <Image
          width={500}
          height={500}
          className="absolute w-[9vw] min-w-lg max-lg:min-w-md max-md:min-w-sm opacity-90 max-lg:-right-16 -right-20 max-md:right-10 max-sm:-right-12 max-sm:min-w-xs -z-1 object-cover -bottom-4"
